...
<div class="flex flex-col gap-4">
    <div class="text-2xl font-bold flex items-center gap-2">
        ...
        <a href="https://github.com/xiaoj655/image-retrieval" target="_self">
    ...
    <div class="border-b-2 border-black">
        在Resnet101预训练模型微调, 完成图像检索任务.
        数据集包括<a href="https://image-retrieval.bitdancing.com/movie_list" target="_blank">223部电影</a>片段, 通过计算平均哈希的方式, 筛选出30万张图片作为数据集
    </div>
